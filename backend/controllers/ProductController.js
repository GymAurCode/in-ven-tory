...
class ProductController {
  ...
  /**
   * Create new product (stock only - no financial calculations)
   */
  static async createProduct(req, res) {
    try {
      ...
      // Insert product only - no financial calculations
      ...
      res.status(201).json({ 
        product: newProduct,
        message: 'Product added to stock successfully. Financial calculations will occur only when products are sold.'
      });
    } catch (error) {
  ...
  /**
   * Update product (stock only - no financial calculations)
   */
  static async updateProduct(req, res) {
    try {
      ...
      // Update product only - no financial calculations
      db.prepare(`
        UPDATE products 
      ...
      res.json({ 
        ...
        message: 'Product updated successfully. Financial calculations will occur only when products are sold.'
      });
    } catch (error) {
